        ...
        <div className="w-full lg:w-1/2 bg-white p-4 sm:p-6 rounded-lg shadow-md">
          <div className="flex flex-col space-y-4">
            <div className="flex flex-col sm:flex-row gap-10">
              ...
              >
                {prismThemes.map((theme) => (
                  <option
                    className="focus:ring-[#538e8e] hover:bg-[#538e8e]"
                    key={theme.value}
                    value={theme.value}
                  >
                    {theme.label}
            ...
            <div
              ...
              className="relative flex md:left-[420px] left-[250px] -mt-10 top-11 text-gray-500 hover:cursor-pointer hover:text-black"
            >
